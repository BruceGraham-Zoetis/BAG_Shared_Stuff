...
from class_analyzer_openapi import analyzer_openapi
...
class CVetscanHub:
    ...
    def analyzer_connected(self, str_IP_Address : str, strName = "") -> analyzer_openapi:
        oAna = analyzer_openapi(str_IP_Address, strName)
        self.dictAnalyzers[str_IP_Address] = oAna
        return True

    def analyzer_set_name(self, str_IP_Address : str, strName : str) -> analyzer_openapi:
        oAna = analyzer_openapi(str_IP_Address, strName)
        self.dictAnalyzers[str_IP_Address] = oAna
        return True
    ...
    def analyzer_get(self, str_IP_Address : str) -> analyzer_openapi:
        try:
            oAna = self.dictAnalyzers[str_IP_Address]
        except:
            oAna = analyzer_openapi("", "")
        return oAna