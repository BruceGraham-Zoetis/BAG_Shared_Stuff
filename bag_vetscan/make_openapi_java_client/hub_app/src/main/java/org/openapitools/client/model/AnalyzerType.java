 ...
 */
@JsonAdapter(AnalyzerType.Adapter.class)
public enum AnalyzerType {
  ...
  public static AnalyzerType fromValue(String value) {
    for (AnalyzerType b : AnalyzerType.values()) {
  ...
  public static class Adapter extends TypeAdapter<AnalyzerType> {
    @Override
    public void write(final JsonWriter jsonWriter, final AnalyzerType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AnalyzerType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AnalyzerType.fromValue(value);
    }
  }
}
