...
public class StatusChannelApiTest {
     ...
     */
    @Test
    public void statusCurrentlyActivatedEventsGetTest() throws ApiException {
        InlineResponse2003 response = api.statusCurrentlyActivatedEventsGet();
     ...
     */
    @Test
    public void statusOperationalGetTest() throws ApiException {
        InlineResponse2002 response = api.statusOperationalGet();
