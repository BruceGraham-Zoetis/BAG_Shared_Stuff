...
public class BodyFileJson {
  public static final String SERIALIZED_NAME_FILENAME = "filename";
  @SerializedName(SERIALIZED_NAME_FILENAME)
  private String filename;


  public BodyFileJson filename(String filename) {
  ...
  **/
  ...
  @ApiModelProperty(example = "/home/files/CPL.txt", required = true, value = "This string will the full path to the file that stores the measurement script as it is stored on the analyzer")
  ...
  public boolean equals(Object o) {
    ...
    BodyFileJson bodyFileJson = (BodyFileJson) o;
    return Objects.equals(this.filename, bodyFileJson.filename);
  }
