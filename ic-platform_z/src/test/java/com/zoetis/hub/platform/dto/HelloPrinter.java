...
public class HelloPrinter {
	...
	public static void main(String[] args) {
		...
		*/
		...
		try {
			inputStream = new FileInputStream("/home/bag/Documents/test_files/file.pdf");
		...
		jobAttributeSet.add(new JobName("123", Locale.getDefault())); 
		...
		job.addPrintJobListener(new PrintJobListener() {
			...
			public void printDataTransferCompleted(PrintJobEvent pje) {
                ...
                for (int i = 0; i < arr.length; i++)
                {
                	...
                	{
                    	System.out.println("arr[" + i + "] name: " + arr[i].getName() + " value: " + arr[i].toString());
